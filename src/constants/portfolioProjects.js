const portfolioProjects = [
  {
    ...
    summary: 'Real-time analytics to spot low-saturation, high-revenue YouTube niches before they explode.',
    status: 'Live case study',
    badges: ['Data analytics', 'ML', 'React'],
    accent: 'blue',
  ...
  },
  {
    ...
    summary: 'Automated lead sourcing, verification, and outreach workflows for B2B teams.',
    status: 'Automation',
    badges: ['Node', 'Scraping', 'PostgreSQL'],
    accent: 'teal',
  ...
  },
  {
    ...
    summary: 'Sequenced email + LinkedIn playbooks with deliverability monitoring and throttling.',
    status: 'In progress',
    badges: ['Sequencing', 'Deliverability', 'APIs'],
    accent: 'purple',
  ...
  },
  {
    ...
    summary: 'Reusable chart primitives, cards, and page shells purpose-built for data products.',
    status: 'UI system',
    badges: ['Design', 'Chart.js', 'Theming'],
    accent: 'pink',
  ...
  },
  {
    ...
    summary: 'Monte Carlo revenue simulations with scenario planning for sales teams.',
    status: 'Data science',
    badges: ['Python', 'Forecasting', 'Dashboards'],
    accent: 'amber',
  ...
  },
  {
    ...
    summary: 'Experiment backlog with impact scoring, success metrics, and reporting.',
    status: 'Case study',
    badges: ['A/B testing', 'Analytics', 'React'],
    accent: 'green',
  ...
  },
  {
    ...
    summary: 'Centralized customer interviews, notes, and sentiment tagging with quick filters.',
    status: 'Research',
    badges: ['UX research', 'NLP', 'Tagging'],
    accent: 'slate',
  ...
  },
  {
    ...
    summary: 'LLM-assisted topic ideation tuned for SEO and YouTube velocity.',
    status: 'Prototype',
    badges: ['LLM', 'SEO', 'Automation'],
    accent: 'violet',
  ...
  },
  {
    ...
    summary: 'Operational metrics, alerting, and runbooks to keep teams on the same page.',
    status: 'Ops',
    badges: ['Monitoring', 'Alerts', 'Playbooks'],
    accent: 'orange',
  ...
  },
  {
    ...
    summary: 'Anomaly detection, freshness tracking, and quality gates across pipelines.',
    status: 'Data reliability',
    badges: ['Quality', 'Observability', 'Alerts'],
    accent: 'cyan',
  ...
  },
  {
    ...
    summary: 'Retention risk scoring with cohort analysis and recommended saves.',
    status: 'ML',
    badges: ['Cohorts', 'Models', 'Dashboards'],
    accent: 'indigo',
  ...
  },
  {
    ...
    summary: 'Partner onboarding, attribution, and performance tracking in one view.',
    status: 'Go-to-market',
    badges: ['Partnerships', 'Attribution', 'Reporting'],
    accent: 'yellow',
